...
public class Validaciones {
	public static final String TEXTO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{3,10}";
	...
	public static final String DIRECCION ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s\\d.]{2,100}";
	public static final String EDAD="[0-9]{2}";
	public static final String TELEFONO="[0-9]{9}";
	//public static final String SEXO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{8,9}";
	public static final String USUARIO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s.\\d]{8,10}";
	public static final String PASSWORD = "[.a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s\\d]{6,15}";
